...
import { getAllPhysicsUnits } from '../data/curriculum'
...
export const PhysicsErrorVault: React.FC<Props> = ({ errorQuestionIds, onRemoveError }) => {
    ...
    return (
      <div className="practice-card" style={{ textAlign: 'center', padding: '2rem' }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: '0.82rem' }}>
          在單元練習或模擬考中答錯的物理題目會自動收錄於此，助您針對盲點精準複習。
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="physics-error-vault">
        ...
        {errorQuestions.map((q) => (
          <div key={q.id} className="practice-card">
            ...
            <div className="solution-card sol-correct" style={{ marginTop: '0.45rem' }}>
              <div className="solution-status">💡 正確解析與公式推導：</div>
