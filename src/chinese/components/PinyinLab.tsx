...
import { CHINESE_TONES, INITIALS_DATA, PINYIN_DRILL_WORDS, type ToneData, type PhonemeData } from '../data/pinyinBopomofo'
...
export const PinyinLab: React.FC<Props> = ({ onEarnXp }) => {
  ...
  const [activeTab, setActiveTab] = useState<'tones' | 'initials' | 'drills'>('tones')
      ...
      <div className="lab-header" style={{ marginBottom: '0.8rem' }}>
        <div>
          ...
          <p className="lab-desc" style={{ margin: 0, fontSize: '0.78rem', color: 'var(--muted)', lineHeight: 1.4 }}>
            日本語にはない「四声の高さのカーブ」と「有気音・そり舌音」を可視化。カタカナの目安と発音ポイントで攻略！
          </p>
        </div>
      </div>
