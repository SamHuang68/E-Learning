...
export const ChineseSidebar: React.FC<Props> = ({
  ...
  const NAV_ITEMS: Array<{ id: ChineseNavSection; icon: string; title: string; subtitle: string; badge?: string }> = [
    ...
    { id: 'dragon-boat', icon: '🛶', title: '端午立蛋與南北粽', subtitle: '正午立蛋・水煮生米vs油飯蒸粽' },
    ...
    { id: 'double-ninth', icon: '⛰️', title: '重陽敬老與菊花茶', subtitle: '登高遠眺踏青・銅鑼杭菊吃重陽糕' },
    { id: 'start-of-winter', icon: '🦆', title: '立冬補冬與薑母鴨', subtitle: '炭火紅泥爐・拌鴨油麵線沾腐乳' },
    { id: 'guabao-sishen', icon: '🍔', title: '傳統刈包與四神湯', subtitle: '虎咬豬咬住福氣・老滷爌肉當歸酒' },
