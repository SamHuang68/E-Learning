...
export const FALSE_FRIENDS_DATA: FalseFriendItem[] = [
  ...
  },
  {
    ...
    pinyin: 'jiāo dài',
    bopomofo: 'ㄐㄧㄠ ㄉㄞˋ',
    meaningZhInJa: '【説明する・指示申し送りする・報告する】',
    meaningJaInJa: '【役割を入れ替わる・バトンタッチ】（中国語では「輪流 / 換班」）',
    pitfallAlertJa: '上司から「這件事你要給我一個交代」と言われたら「この件をしっかり説明・釈明しなさい」という意味です。',
    exampleSentenceZh: '主管交代我明天要準時交報告。',
  ...
  },
  {
    ...
    pinyin: 'xīn wén',
    bopomofo: 'ㄒㄧㄣ ㄨㄣˊ',
    meaningZhInJa: '【ニュース全般（TV・ネット・報道）】',
    meaningJaInJa: '【紙の新聞紙】（中国語では「報紙 bào zhǐ」）',
    pitfallAlertJa: '中国語の「看新聞」はテレビやネットのニュースを見ることも含みます。紙の新聞を買う時は「買報紙」です。',
    exampleSentenceZh: '我每天早上都會看電視新聞。',
  ...
  },
  {
    ...
    pinyin: 'fàn diàn',
    bopomofo: 'ㄈㄢˋ ㄉㄧㄢˋ',
    meaningZhInJa: '【大型ホテル・高級旅館・レストラン】',
    meaningJaInJa: '【中華料理店・大衆食堂】（中国語では「小吃店 / 餐館」）',
    pitfallAlertJa: '台湾で「五星級飯店」は五つ星ホテルのこと！ただの中華飯店ではありません。',
    exampleSentenceZh: '我們這次去花蓮住在海景飯店。',
  ...
  },
  {
    ...
    pinyin: 'dà fāng',
    bopomofo: 'ㄉㄚˋ ㄈㄤ',
    meaningZhInJa: '【気前が良い・寛大・堂々としている】',
    meaningJaInJa: '【大部分・おおかた】（中国語では「大概 / 大多數」）',
    pitfallAlertJa: '「他很大方」は「彼は気前がよくてケチケチしない」という褒め言葉です。',
    exampleSentenceZh: '老闆今天很大方，請大家吃下午茶。',
  ...
  },
  {
    ...
    pinyin: 'fāng biàn',
    bopomofo: 'ㄈㄤ ㄅㄧㄢˋ',
    meaningZhInJa: '【都合が良い・便利・（婉曲に）トイレに行く】',
    meaningJaInJa: '【便宜的な手段・嘘も方便】',
    pitfallAlertJa: '「您現在方便說話嗎？」はビジネス電話で「今お話ししてもご都合よろしいですか？」という必須の気配りフレーズです。',
    exampleSentenceZh: '請問您現在方便通電話嗎？',
