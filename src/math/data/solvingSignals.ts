...
export const MATH_SOLVING_SIGNALS: MathSolvingSignal[] = [
  ...
  // R16: Algebra factoring SRS deck +10 (deeper coverage of 10 core techniques)
  {
    id: 'sig-factor-diff-squares',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 平方差公式',
    problemSignal: '題目出現 $a^2 - b^2$ 或「平方差」形式的多項式',
    threeSecondRule: '【平方差直接拆因式】$a^2 - b^2 = (a - b)(a + b)$，立即寫出兩因式！',
    firstStepFormula: 'a^2 - b^2 = (a - b)(a + b)',
    exampleProblem: {
      question: '因式分解 $x^2 - 9$',
      quickSolve: '$x^2 - 3^2 = (x - 3)(x + 3)$。',
    },
  },
  {
    id: 'sig-factor-perfect-square',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 完全平方三項式',
    problemSignal: '題目出現 $a^2 + 2ab + b^2$ 或 $a^2 - 2ab + b^2$ 形式',
    threeSecondRule: '【完全平方公式】$a^2 \\pm 2ab + b^2 = (a \\pm b)^2$，直接開方合併！',
    firstStepFormula: 'a^2 + 2ab + b^2 = (a + b)^2',
    exampleProblem: {
      question: '因式分解 $x^2 + 6x + 9$',
      quickSolve: '$x^2 + 2\\cdot3x + 3^2 = (x + 3)^2$。',
    },
  },
  {
    id: 'sig-factor-grouping',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 分組因式',
    problemSignal: '題目出現四項式，可兩兩分組且有公因數',
    threeSecondRule: '【分組提取公因數再合併】(ax + ay + bx + by) = a(x+y) + b(x+y) = (a+b)(x+y)！',
    firstStepFormula: 'ax + ay + bx + by = (a + b)(x + y)',
    exampleProblem: {
      question: '因式分解 $x^3 + x^2 + 2x + 2$',
      quickSolve: '$x^2(x + 1) + 2(x + 1) = (x^2 + 2)(x + 1)$。',
    },
  },
  {
    id: 'sig-factor-sum-cubes',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 立方和公式',
    problemSignal: '題目出現 $a^3 + b^3$ 或立方和形式',
    threeSecondRule: '【立方和拆因式】$a^3 + b^3 = (a + b)(a^2 - ab + b^2)$，記住三項！',
    firstStepFormula: 'a^3 + b^3 = (a + b)(a^2 - ab + b^2)',
    exampleProblem: {
      question: '因式分解 $x^3 + 8$',
      quickSolve: '$x^3 + 2^3 = (x + 2)(x^2 - 2x + 4)$。',
    },
  },
  {
    id: 'sig-factor-diff-cubes',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 立方差公式',
    problemSignal: '題目出現 $a^3 - b^3$ 或立方差形式',
    threeSecondRule: '【立方差拆因式】$a^3 - b^3 = (a - b)(a^2 + ab + b^2)$，符號交替！',
    firstStepFormula: 'a^3 - b^3 = (a - b)(a^2 + ab + b^2)',
    exampleProblem: {
      question: '因式分解 $x^3 - 27$',
      quickSolve: '$x^3 - 3^3 = (x - 3)(x^2 + 3x + 9)$。',
    },
  },
  {
    id: 'sig-factor-quadratic',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 二次三項式',
    problemSignal: '題目給定二次三項式 $ax^2 + bx + c$，要求因式分解',
    threeSecondRule: '【找兩數乘積c、和b】分解常數項，配對係數後拆！',
    firstStepFormula: 'ax^2 + bx + c = (px + q)(rx + s) 其中 pr=a, qs=c, ps + qr = b',
    exampleProblem: {
      question: '因式分解 $2x^2 + 7x + 6$',
      quickSolve: '2×6=12，找 3+4=7 → (2x + 3)(x + 2)。',
    },
  },
  {
    id: 'sig-factor-rational-root',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 有理根定理',
    problemSignal: '題目給定高次多項式，需找可能有理根來試除',
    threeSecondRule: '【可能根 p/q】p 為常數項因數，q 為首項因數，逐一帶入測試！',
    firstStepFormula: '可能有理根 = \\pm \\frac{\\text{常數項因數}}{\\text{首項因數}}',
    exampleProblem: {
      question: '因式分解 $x^3 - 6x^2 + 11x - 6$',
      quickSolve: '可能根 1,2,3,6；試 x=1: f(1)=0 → (x-1) 為因式，合成除法得 (x-2)(x-3)。',
    },
  },
  {
    id: 'sig-factor-common-monomial',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 公因式提取',
    problemSignal: '題目出現多項式各項有明顯公因數',
    threeSecondRule: '【最大公因數提取】先提 GCF，再分解剩餘部分！',
    firstStepFormula: 'GCF \\times (剩餘多項式)',
    exampleProblem: {
      question: '因式分解 $6x^3 + 9x^2 - 3x$',
      quickSolve: 'GCF=3x → 3x(2x^2 + 3x - 1)。',
    },
  },
  {
    id: 'sig-factor-trinomial-group',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 三項式分組',
    problemSignal: '題目出現可改寫為四項再分組的三項式',
    threeSecondRule: '【拆中項分組】把 bx 拆成兩項，配對後提取！',
    firstStepFormula: 'ax^2 + (m+n)x + c = ax^2 + mx + nx + c',
    exampleProblem: {
      question: '因式分解 $x^2 + 5x + 6$',
      quickSolve: '$x^2 + 2x + 3x + 6 = x(x+2) + 3(x+2) = (x+3)(x+2)$。',
    },
  },
  {
    id: 'sig-factor-synthetic',
    stage: 'senior',
    gradeBand: '高中十年級',
    topic: '代數 · 因式分解 · 合成除法',
    problemSignal: '題目要求多項式除以 (x - c) 且判斷是否可整除',
    threeSecondRule: '【合成除法快速除】帶根 c 做快速合成，餘數 0 即整除！',
    firstStepFormula: '合成除法表格：c | a b c d → 商 + 餘',
    exampleProblem: {
      question: '$x^3 - 3x^2 - 4x + 12$ 除以 (x-2) 是否整除？',
      quickSolve: '合成除 2 | 1 -3 -4 12 → 商 x^2 -x -6，餘 0 → (x-2)(x^2 -x -6)。',
    },
  },
]
